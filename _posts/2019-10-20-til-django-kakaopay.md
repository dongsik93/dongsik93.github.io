...
![pay1](/img/in-post/kakaopay/pay1.png)
...
![pay2](/img/in-post/kakaopay/pay2.png)
...
![pay3](/img/in-post/kakaopay/pay3.png)
...
- `.then` 을 통해서 성공에 대한 결과를 처리
  ...
  ![pay4](/img/in-post/kakaopay/pay4.png)

  - payUrl 이동 결과 화면
  - 휴대폰 번호와 생년 월일을 입력 후 화면

  ![pay5](/img/in-post/kakaopay/pay5.png)

  - 핸드폰으로 들어가서 진행을 해보자

  ![pay6](/img/in-post/kakaopay/pay6.jpeg)

  - 위에서 10,000으로 요청한 금액과, 상품이름인 포인트, 부가세가 잘 적용된 모습이다.

  ![pay7](/img/in-post/kakaopay/pay7.jpeg)

  - 테스트 환경이기 때문에 카카오페이 비밀번호 인증단계가 생략된 모습이다

  ![pay8](/img/in-post/kakaopay/pay8.jpeg)

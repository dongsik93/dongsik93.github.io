...
![스크린샷 2020-03-24 오후 3.56.17](/img/in-post/md_1.png)
...
- Bar
  ...
  ![스크린샷 2020-03-24 오후 4.00.06](/img/in-post/md_2.png)
...
![스크린샷 2020-03-24 오후 4.03.52](/img/in-post/md_3.png)
...
![스크린샷 2020-03-24 오후 4.11.30](/img/in-post/md_4.png)
...
![스크린샷 2020-03-24 오후 4.15.35](/img/in-post/md_5.png)
...
- ##### BottomNavigation
  ...
  ![스크린샷 2020-03-24 오후 4.28.56](/img/in-post/md_6.png) ![스크린샷 2020-03-24 오후 4.35.11](/img/in-post/md_7.png)
...
- ##### Navigation drawer
  ...
  ![스크린샷 2020-03-24 오후 4.43.35](/img/in-post/md_8.png)
...
- ##### Navigation rail
  ...
  ![스크린샷 2020-03-24 오후 4.51.43](/img/in-post/md_9.png)
...
- 버튼은 dialog, modal window, formm, card, toolbar등 여러곳에서 자주 쓰인다
  ...
  ![스크린샷 2020-03-25 오후 2.57.55](/img/in-post/md_10.png)
  ...
  - 버튼의 강조 수준은 3단계로 나뉜다
    ...
    ![스크린샷 2020-03-25 오후 3.00.05](/img/in-post/md_11.png)

    - 이러한 강조 수준으로 모양, 글자 타입, 위치등이 결정된다

  - 버튼의 상태

    ![스크린샷 2020-03-25 오후 3.00.49](/img/in-post/md_12.png)
...
- 카드는 하나의 주제에 대한 내용과 액션들을 포함하고 있다
  ...
  ![스크린샷 2020-03-25 오후 3.01.36](/img/in-post/md_13.png)
...
- 각각의 카드는 내용 블록으로 이루어져 있다. 이 모든 블록은 전체적으로 하나의 주제나 목적지와 관련이 있다
  ...
  ![스크린샷 2020-03-25 오후 3.02.56](/img/in-post/md_14.png)

- 카드에는 사용자가 카드의 내용과 상호작용을 할 수 있도록 UI 제어가 포함될 수 있다

  ![스크린샷 2020-03-25 오후 3.03.35](/img/in-post/md_15.png)
...
![스크린샷 2020-03-25 오후 3.04.39](/img/in-post/md_16.png)![스크린샷 2020-03-25 오후 3.04.48](/img/in-post/md_17.png)

![스크린샷 2020-03-25 오후 3.04.57](/img/in-post/md_18.png)![스크린샷 2020-03-25 오후 3.05.04](/img/in-post/md_19.png)
...
![스크린샷 2020-03-24 오후 3.38.07](/img/in-post/md_20.png)
...
- 사용자가 날짜 또는 날짜 범위를 선택할 수 있는 날짜 선택기
  ...
  ![스크린샷 2020-03-25 오후 3.08.56](/img/in-post/md_21.png)
...
- 진행률을 보여주는 요소로서 지정되지 않은 대기시간을 표시하거나 프로세스의 길이를 보여준다
  ...
  ![스크린샷 2020-03-25 오후 3.11.12](/img/in-post/md_22.png)
...
- Radio buttons 
  ...
  ![스크린샷 2020-03-25 오후 3.12.49](/img/in-post/md_23.png)
...
- Checkboxes 
  ...
  - 하위 선택 항목이 포함된 목록 표시
    ...
    ![스크린샷 2020-03-25 오후 3.14.02](/img/in-post/md_24.png)
...
- switches 
  ...
  ![스크린샷 2020-03-25 오후 3.14.48](/img/in-post/md_25.png)
...
- 화면 아래쪽으로 일시적으로 나타나며, 사용자 경험을 방해해서는 안되고 사용자 입력이 사라지도록 요구하지 않는다
  ...
  ![스크린샷 2020-03-25 오후 3.16.01](/img/in-post/md_26.png)
...
- Filled text field, Outlined text 로 나뉜다 
  ...
  ![스크린샷 2020-03-25 오후 3.17.29](/img/in-post/md_28.png)
...
- 보조 요소들
  ...
  ![스크린샷 2020-03-25 오후 3.43.35](/img/in-post/md_29.png)
...
- Input type
  ...
  - Single line text field 
    ...
    - 긴 문장을 입력받는데에는 적합하지 않다
      ...
      ![스크린샷 2020-03-25 오후 3.46.11](/img/in-post/md_30.png)
  ...
  - Multi-line text field
    ...
    ![스크린샷 2020-03-25 오후 3.46.58](/img/in-post/md_31.png)
  ...
  - Text areas
    ...
    ![스크린샷 2020-03-25 오후 3.47.37](/img/in-post/md_32.png)

  - Ready-only field

    - 사용자가 편집할 수 없는 미리 채워진 텍스트가 표시된다

    ![스크린샷 2020-03-25 오후 3.47.37](/img/in-post/md_33.png)

...
다만 미국 쪽 데이터를 보면 또 다른 흐름도 있는 것 같다. 내가 미국주식 블로그에서 정리했던 시타델 리포트 쪽은 전체 고용이 정체된 와중에도 AI 개발자와 소프트웨어 엔지니어 채용이 늘어난다는 쪽에 가까웠다. ([30초 미주, 시타델 리포트 정리](https://miju30.com/ai-developer-hiring-citadel-report-202605/)) 결국 개발자 수요가 그냥 사라진다기보다는, 신입 개발자에게 기대하던 일과 AI를 다룰 수 있는 개발자에게 기대하는 일이 갈라지고 있는 것 같다.
